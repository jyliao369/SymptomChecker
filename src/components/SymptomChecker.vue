<template>
  <div v-if="showSymptomModal">
    <SymptomModal :symptoms="symptoms" @close="openSymptomModal" />
  </div>
  <div>
...
export default {
  ...
  mounted() {
    fetch(
      "https://sandbox-healthservice.priaid.ch/symptoms?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..qJL-u5NfVYZ0nOA1Xy_eOxo4GZcPPsE1oSH-LcltpFU&format=json&language=en-gb"
    )
      .then((response) => response.json())
      .then((data) => (this.symptoms = data))
      .catch((err) => console.log(err.message));
